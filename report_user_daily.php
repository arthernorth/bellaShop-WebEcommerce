        ...
        <div id="fh5co-product">
            <div class="container">
                <div class="row">
                    ...
                    ?>
                    <form action="report_user_daily.php" method="get">
                            ...
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql_data = "   SELECT  * , COUNT(rep_count) as user_count
                                                            FROM report_user
                                                            WHERE rep_date = '" . $_GET['finddate'] . "' 
                                                            GROUP BY rep_id
                                                            ORDER BY rep_id ";
                                            ...
                                            while ($data_array = $res_data->fetch(PDO::FETCH_ASSOC)) {
                                                $j++;
                                                if($_SESSION['user_level'] == 'admin' && $data_array['rep_timeout'] == '00:00:00'){
                                                    $timeout = "Online"; 
                                                }else{
                                                    $timeout = $data_array['rep_timeout']; 
                                                }
                                            ?>
                                                <tr>
                                                    <td>
