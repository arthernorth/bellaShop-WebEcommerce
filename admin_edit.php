                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?= $data_arr['user_name'] ?></td>
                                            <td><?= $data_arr['user_level'] ?></td>
                                            <td><?= $data_arr['user_phone'] ?></td>
                                            <td>
                                                <center>
                                                    <a href="admin_user_edit.php?user_id=<?= $data_arr['user_id'] ?>">
                                            ...
                                            <td>
                                                <center>
                                                    <a onclick="user_delete('<?= $data_arr['user_id'] ?>')">
