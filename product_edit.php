                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <input type="hidden" value="<?=$data_arr['product_id']?>" name="product_id" >
                                            <td>PDI: <?= $data_arr['product_id'] ?></td>
                                            <td><input type="text" value="<?=$data_arr['product_name']?>" name="product_name" ></td>
                                            <td><input type="text" value="<?= $data_arr['product_cat'] ?>" name="product_cat" ></td>
                                            <td><input type="text" value="<?= $data_arr['product_price'] ?>" name="product_price" ></td>
                                            <td><input type="text" value="<?= $data_arr['cur_stk'] ?>" name="cur_stk" ></td>
